...
module.exports = async (req, res) => {
  ...
  const getName = ({ company, first_name, last_name }) => {
  ...
  const postMail = (email, template) => {
    const sub = subject || 'Factoryhunt.com - Share your catalog with us and promote to buyers.'
    const message = {
