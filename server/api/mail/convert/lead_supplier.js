...
module.exports = async (req, res) => {
  const { lead_id, inquiry, sender_id } = req.body
  ...
  const getEmailTemplate = (inquiry, company, sender) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        const template = getTemplate(inquiry, token, sender)
        resolve(template)
      } catch (err) {
