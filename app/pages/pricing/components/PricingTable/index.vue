  ...
  <main class="wrapper">
    <div class="maxwidth">
      <div class="table">
        <!-- Free -->
        <div
          class="table-item free">
          <h2 class="title">Free</h2>
          <div class="price-wrapper">
            <p class="price"><i>$ 0</i></p>
          </div>
          <a 
            class="button" 
        ...
        <div
          ...
          <a 
            href="/contact"
            class="button coming-soon">Contact Us</a>
        </div>
      </div>
    </div>
  </main>
...
.wrapper {
  ...
  &::after {
    ...
    background: linear-gradient(170deg, rgba(242, 88, 61, 1) 0%, rgba(167, 63, 44, 1) 100%);
