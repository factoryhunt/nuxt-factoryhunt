    ...
    <form class="form-container" @submit.prevent="onEditButton">
      ...
      <div 
        ...
        <div class="box-container">
          ...
          <div class="right-contents">
            <input 
              ...
              :placeholder="$t('dashboardCompany.company.state.placeholder')" v-model="value.state"></div>
        </div>
        <!-- City -->
        <div class="box-container">
          ...
          <div class="right-contents">
            <input 
              ...
              :placeholder="$t('dashboardCompany.company.city.placeholder')" v-model="value.city"></div>
        </div>
        <!-- Street Address -->
        <div class="box-container">
          ...
          <div class="right-contents">
            <input 
              ...
              :placeholder="$t('dashboardCompany.company.street.placeholder')" v-model="value.streetAddress"></div>
        </div>
        ...
        <div class="box-container">
          ...
          <div class="right-contents">
            ...
            :placeholder="$t('dashboardCompany.company.street2.placeholder')" v-model="value.streetAddressDetail"></div>
        </div>
        <!-- Postal Code -->
        <div class="box-container">
      ...
      <div 
        ...
        <textarea 
          ...
          pattern="[A-Za-z0-9 ().,]{1,25000}" 
          :title="$t('dashboardCompany.description.inputTitle')" 
          maxlength="25000" 
          rows="10" 
          :placeholder="$t('dashboardCompany.description.placeholder')" v-model="value.description"></textarea>
      </div>
...
export default {
      ...
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: `https://www.factoryhunt.com/dashboard/company`
        }
      ]
    }
  },
  ...
  methods: {
    ...
    async onEditButton() {
      ...
      if (!checkboxArrayToString(businessType, this.value.businessTypes))
        return this.onEditFail(this.$t('alert.required'))
      ...
      // request
      try {
        await Promise.all([this.uploadCompanyData(), this.uploadPDF()])
    ...
    uploadCompanyData() {
      const data = {
        ...
        accepted_delivery_terms: checkboxArrayToString(
          acceptedDeliveryTerms,
          this.value.acceptedDeliveryTerms
        ),
        accepted_payment_currency: checkboxArrayToString(
          acceptedPaymentCurrency,
          this.value.acceptedPaymentCurrency
        ),
        accepted_payment_type: checkboxArrayToString(
          acceptedPaymentType,
          this.value.acceptedPaymentType
        ),
