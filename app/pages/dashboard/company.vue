      ...
      <div class="profile-container">
        <div class="profile-inner-container">
          <div class="menu-container">
            <a 
              id="item-company-edit" 
              class="menu" 
              href="/dashboard/company">{{ $t('dashboardCompany.editCompany') }}</a>
            <a 
              id="item-domain-edit" 
              class="menu" 
              href="/dashboard/company/domain"
              v-show="isUserSupplier">{{ $t('dashboardCompany.editDomain') }}</a>
            <a 
              id="item-image-edit" 
              class="menu" 
              href="/dashboard/company/image">{{ $t('dashboardCompany.images') }}</a>
            <a 
              id="item-type-edit" 
              class="menu" 
              href="/dashboard/company/type">Account Type</a>
            ...
            <button 
              ...
              v-show="isUserSupplier">{{ $t('dashboardCompany.viewButton') }}</button>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    highlightNavigationButton() {
      $(document).ready(() => {
        ...
        if (name === 'dashboard-company-type') {
          $('#item-type-edit').attr('aria-selected', true)
        }
    ...
    unhighlightNavigationButton() {
      ...
      $('#item-type-edit').attr('aria-selected', false)
