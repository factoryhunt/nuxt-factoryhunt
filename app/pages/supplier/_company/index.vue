    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'description',
          name: 'description',
          content: `${this.lead.company}, ${this.lead.products} | Factory Hunt`
        },
        { hid: 'og-title', property: 'og:title', content: this.lead.company },
        {
          hid: 'og-description',
          property: 'og:description',
          content: this.$t('supplier.ogDescription')
        },
        { hid: 'og-url', property: 'og:url', content: `factoryhunt.com/${this.lead.domain}` },
        {
          hid: 'twitter-title',
          property: 'twitter:title',
          content: `${this.lead.company} | Factory Hunt`
        },
        {
        ...
        },
        {
          ...
          content: `https://www.factoryhunt.com/supplier/${this.lead.company}?id=${
            this.lead.lead_id
          }`
        }
      ],
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: `https://www.factoryhunt.com/supplier/${this.lead.company}?id=${this.lead.lead_id}`
        }
      ]
    }
  },
    ...
    async sendInquiry() {
      ...
      const sendConvertMail = () => {
        ...
        return new Promise((resolve, reject) => {
          axios
            .post('/api/mail/convert_lead_supplier', payload)
            .then(_ => resolve())
