      ...
      meta: [
        {
          hid: 'keywords',
          name: 'keywords',
          content: `${this.vendor.account_name}, ${
        ...
        },
        {
          hid: 'description',
          name: 'description',
          content: `${this.vendor.company_description}, ${this.vendor.products} | Factory Hunt`
        },
        { hid: 'og-title', property: 'og:title', content: this.vendor.account_name },
        {
          hid: 'og-description',
          property: 'og:description',
          content: this.vendor.company_description
        },
        ...
        { hid: 'twitter-card', property: 'twitter:card', content: 'summary' },
        {
          ...
          content: `${this.vendor.account_name} | Factory Hunt`
        },
        {
          hid: 'twitter-description',
          property: 'twitter:description',
          content: `${this.vendor.company_description} | Factory Hunt`
        },
        {
          hid: 'twitter-image',
        ...
        },
        {
          ...
          content: `https://www.factoryhunt.com/${this.vendor.domain}`
        }
      ],
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: `https://www.factoryhunt.com/${this.vendor.domain}`
        }
      ]
    }
  },
  ...
  computed: {
    ...
    getAddress() {
      const street = this.vendor.mailing_street_address
        ...
        : ''
      const street2 = this.vendor.mailing_street_address_2
        ? this.vendor.mailing_street_address_2 + ', '
        : ''
      const city = this.vendor.mailing_city ? this.vendor.mailing_city + ', ' : ''
      const state = this.vendor.mailing_state ? this.vendor.mailing_state + ', ' : ''
      const country = this.vendor.mailing_country
  ...
  methods: {
    ...
    applySmoothScrolling() {
      ...
      $(document).ready(() => {
        ...
        $('.sticky-item').click(function(event) {
          if (
